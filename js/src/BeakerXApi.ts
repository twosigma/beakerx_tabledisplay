...
export class BeakerXApi {
  ...
  readonly DEFAULT_SETTINGS: BeakerXApi.IApiSettingsResponse = {
    jvm_options: {
      heap_GB: null,
      other: [],
      properties: []
  ...
  public loadSettings(): Promise<BeakerXApi.IApiSettingsResponse> {
    return new Promise((resolve, reject) => {
  ...
  public mergeWithDefaults(settings: BeakerXApi.IApiSettingsResponse): BeakerXApi.IApiSettingsResponse {
  ...
  public saveSettings(data: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      ...
      $.ajax(this.getApiUrl('settings'), {
        ...
        headers: {
          'X-XSRFToken': BeakerXApi.getCookie('_xsrf')
        },
        success: (data, status) => {
          resolve();
        },
